 ...
 *   Compile with:
 *
 *   nvcc -O4 -arch=<cuda_arch> -I../ test_mem_multi_4int.cu -o test_mem_multi_4int
 *
 *   thrust codepath  (-DTHRUST) seems not to be up to date in this test - may give wrong results here
 *
 */
